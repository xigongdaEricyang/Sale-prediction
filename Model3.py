...
df = pd.read_csv(r'C:\Users\xigon\Desktop\aa\Sale-prediction\final.csv')
# random shift the df
...
train_x, test_x, train_y, test_y = train_test_split(inputX, inputY, test_size=0.33, random_state=42)
